...
const UPDATE_INTERVAL = 6000; // 🔁 6 seconds interval (6000ms)
...
const WEATHER_API_KEY = "2d1a16338665b741fb4d4b8bacb7f283"; // 🔑 Replace with your OpenWeatherMap API key
const WEATHER_CITY = "Jaipur, IN"; // 🏙️ Change as needed
...
async function fetchWeatherData() {
    try {
        const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${jaipur}&appid=$2d1a16338665b741fb4d4b8bacb7f283}&units=metric`);
        ...
        console.warn("⚠️ Weather API failed, using simulated weather.", error);
